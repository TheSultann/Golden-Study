...
exports.AuthDataValidator = void 0;
...
class AuthDataValidator {
    ...
    inValidateDataAfter;
    throwIfEmptyData;
    constructor({ botToken = '', subtleCrypto, encoder, inValidateDataAfter = 86400, throwIfEmptyData = true, } = {}) {
     ...
     */
    assertValidCrypto(subtleCrypto) {
        const cryptoToUse = 
    ...
    async validate(authDataMap) {
        ...
        const signature = (0, utils_1.hexStringToArrayBuffer)(hashFromTelegram.toString());
        /**
        ...
        if (isWebAppData) {
            ...
            data = Object.fromEntries(authData.entries());
        }
     ...
     */
    async getSecretKey(isWebAppData) {
        let secret;
        if (isWebAppData) {
            /**
             * @see https://core.telegram.org/bots/webapps#validating-data-received-via-the-web-app
             */
            const secretKey = await this.crypto.importKey('raw', this.encoder.encode('WebAppData'), { name: 'HMAC', hash: 'SHA-256' }, true, ['sign', 'verify']);
...
exports.AuthDataValidator = AuthDataValidator;
//# sourceMappingURL=AuthDataValidator.js.map